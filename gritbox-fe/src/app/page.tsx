        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">Read our latest articles and insights</p>
            </Link>
            ...
            <Link 
              ...
              className="p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 transition-colors"
            >
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Projects</h2>
              <p className="text-gray-600 dark:text-gray-300">Explore our case studies and art projects</p>
            </Link>
            ...
            <Link 
              ...
              className="p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 transition-colors"
            >
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Free Resources</h2>
              <p className="text-gray-600 dark:text-gray-300">Download our free tools and resources</p>
            </Link>
